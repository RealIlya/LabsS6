...
public static class DataStore
{
    ...
    public static List<Book> SearchBooks(string title = null, string author = null,
                                          string genre = null, int? yearFrom = null, int? yearTo = null)
    {
        DataTable dt = DBHelper.ExecuteQuery("sp_SearchBooks",
            ...
            new SqlParameter("@YearFrom", yearFrom.HasValue ? (object)yearFrom.Value : DBNull.Value),
            new SqlParameter("@YearTo", yearTo.HasValue ? (object)yearTo.Value : DBNull.Value));
